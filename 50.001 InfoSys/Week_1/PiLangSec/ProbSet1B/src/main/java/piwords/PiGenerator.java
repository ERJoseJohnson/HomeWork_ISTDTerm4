...
public class PiGenerator {
    /**
     * Returns precision hexadecimal digits of the fractional part of pi. Returns
     * digits in most significant to least significant order.
     * 
    ...
    public static int[] computePiInHex(int precision) {
        ...
        int hexNumbers[] = new int[precision];
        for (int i = 0; i < precision; i++) {
            hexNumbers[i] = piDigit(i + 1); // TODO: why are we doing this, find out
        }
        return hexNumbers;
    }
